     ...
     <div
        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24  '>
          ...
          <div className='flex flex-col md:flex-row items-center md:space-x-12 '>
            <img src={mernimage} alt="" className='w-72 h-80 rounded object-cover mb-8 md:mb-0' />
            <div className='flex-1'>
              <p className="text-lg mb-8 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit dolores optio debitis magni recusandae hic animi, fugiat similique praesentium cum ipsam cumque minus et, consectetur quos provident, architecto quisquam ad.</p>
              <div className='space-y-4 '>

                <div className='flex items-center gap-3'>
                  <label htmlFor="html$css" className='lg:w-2/12 w-3/12' >html&css</label>
